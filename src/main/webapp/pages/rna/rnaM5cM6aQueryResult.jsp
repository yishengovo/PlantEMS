                ...
                <div class="testimony text-center" align="center" style="font-family: verdana,arial,sans-serif;">
                    ...
                    <fieldset align="center">
                        ...
                        <div class="text1-nav">
                            ...
                            <input type="checkbox" name="filter" value="4" checked="checked">Start</input><br>
                            <input type="checkbox" name="filter" value="5" checked="checked">End</input><br>
                            <input type="checkbox" name="filter" value="6" checked="checked">Summit</input><br>
                            <input type="checkbox" name="filter" value="7" checked="checked">Type</input><br>
                            <input type="checkbox" name="filter" value="8" checked="checked">Gene</input><br>
                            <input type="checkbox" name="filter" value="9" checked="checked">Feature</input><br>
                            <input type="checkbox" name="filter" value="10" checked="checked">Strand</input><br>
                            <input type="checkbox" name="filter" value="11" checked="checked">Context</input><br>
                        </div>
                    </fieldset>
            ...
            <div class="col-md-4 animate-box" style="width: 80%; padding-left: 0px">
                <div class="testimony text-center">
                    ...
                    <table border="1" cellpadding="0" align="center" class="imagetable1">
                        ...
                        <tbody>
                        <c:forEach items="${page.items}" var="rna">
                            <tr>
                                <td>${rna.id}</td>
