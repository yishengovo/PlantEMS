                    ...
                    <table border="1" cellpadding="0" align="center" class="imagetable1">
                        ...
                        <c:forEach items="${page.items}" var="dna">
                            <tr>
                                ...
                                <td>${dna.strand}</td>
                                <td hidden="hidden">${dna.score}</td>
                                <td hidden="hidden">${dna.coverage}</td>
                                <td hidden="hidden">${dna.fraction}</td>
                                <td hidden="hidden">${dna.identificationQv}</td>
                                <td hidden="hidden">${dna.ipdRation}</td>
                                <td>${dna.context}</td>
                            </tr>
                        </c:forEach>
                        </tbody>
